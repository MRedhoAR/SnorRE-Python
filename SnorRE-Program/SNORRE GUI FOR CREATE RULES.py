...
#Functions
def mAbout():
    messagebox.showinfo(title='Tentang',message='Tentang saya')
    return
...
def mQuit():
    mexit=messagebox.askokcancel(title='Keluar',message='Yakin ingin keluar?')
    if mexit>0:
        snort.destroy()
        return
##########################################################################################	
...
#ClassTypes
mylist8=['attempted-admin','attempted-user','inappropriate-content','policy-violation','shellcode-detect','trojan-activity','web-application-attack','attempted-dos','attempted-recon','denial-of-service','misc-attack','web-application-activity','misc-activity','network-scan','icmp-event']
var8=StringVar()
var8.set("Select")
...
def Rulecreate():
    ...
    if var.get() == "Select" or var2.get() == "Select" or var3.get() == "Select" or var4.get() == "Select" or var5.get() == "Select" or var6.get() == "Select":
        messagebox.showwarning("PERINGATAN!!","Peraturan header bermasalah")
    else:
        global Ruleheader
        global Rulebody
        global Ruleend
...
filemenu.add_command(label="Buka",command=mOpen)
filemenu.add_command(label="Simpan Sebagai")
#filemenu.add_command(label="Colour", command=mColor)
filemenu.add_command(label="Keluar", command=mQuit)
menubar.add_cascade(label="File",menu=filemenu)


#Edit
editmenu=Menu(menubar,tearoff=0)
editmenu.add_command(label="Pencarian File")
editmenu.add_command(label="Edit URL")
editmenu.add_command(label="Edit Proxy")
editmenu.add_command(label="Edit Jaringan Local")
menubar.add_cascade(label="Edit",menu=editmenu)


#Tools
insertmenu=Menu(menubar,tearoff=0)
insertmenu.add_command(label="Tambahkan Proxy Server")
insertmenu.add_command(label="Tambahkan URL")
insertmenu.add_command(label="Tambahkan IP")
insertmenu.add_command(label="Tambahkan Jaringan")
insertmenu.add_command(label="Tambahkan LAN")
menubar.add_cascade(label="Masukkan",menu=insertmenu)

#Help menu
helpmenu=Menu(menubar,tearoff=0)
helpmenu.add_command(label="Tentang",command=mAbout)
helpmenu.add_command(label="Bagaimana?")
helpmenu.add_checkbutton(label="Periksa?")
